...
phase0=-90;
purelysine = tonepip(amp, freq, delay, duration, rf, phase0, sampfreq, ipi, np, alternate);
%figure(52); plot(purelysine)
stimlen = length(purelysine);
sineM = ones(stimlen,1)+0.7.*tonepip(1, modfreq, delay, duration, rf, phase0, sampfreq, ipi, np, alternate);
%figure(53); plot(sineM);
sam = purelysine .* sineM
